...
def main():
    ...
    # Variables for periodic alerts during sustained detection
    ...
    while True:
        ...
        if intruder and (now - last_intruder_time > 3):
            ...
            if not recording:
                ...
                # Queue async alerts (non-blocking)
        ...
        # ================= CONTINUOUS MONITORING WHILE DETECTED =================
        if intruder and recording:
            # Queue Telegram snapshot every 5 seconds (non-blocking)
            ...
            # Queue Email snapshot every 15 seconds (non-blocking)
