...
RECORDING_FPS = 20  # Consistent FPS for recording
...
def start_recording(frame):
    ...
    # ===== FIX: Use RECORDING_FPS constant instead of hardcoded 20 =====
    video_writer = cv2.VideoWriter(
        current_video_path,
        fourcc,
        RECORDING_FPS,  # Changed from 20 to RECORDING_FPS
        (640, 360)
    )
...
def main():
    ...
    while True:
        ...
        # ===== FIX: Changed from 0.03 to match RECORDING_FPS =====
